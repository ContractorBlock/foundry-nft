...
.PHONY: all test clean deploy fund help install snapshot format anvil deploy mint deployMoodNft
...
mint:
	@forge script script/Interactions.s.sol:InteractionsMintBasicNft ${NETWORK_ARGS}
